...
#define MASK_CONTROL_MACRO3_EDGE(tex,state,control) float3( \
        lerp(1.0,UNITY_SAMPLE_TEX2D_SAMPLER_LOD(tex,state,uv_edge[0],0.0).x,control), \
        lerp(1.0,UNITY_SAMPLE_TEX2D_SAMPLER_LOD(tex,state,uv_edge[1],0.0).x,control), \
        lerp(1.0,UNITY_SAMPLE_TEX2D_SAMPLER_LOD(tex,state,uv_edge[2],0.0).x,control) \
    )
...
#define OFFSET_CONTROL_MACRO3_EDGE(tex,state,control) float3( \
        UNITY_SAMPLE_TEX2D_SAMPLER_LOD(tex,state,uv_edge[0],0.0).x, \
        UNITY_SAMPLE_TEX2D_SAMPLER_LOD(tex,state,uv_edge[1],0.0).x, \
        UNITY_SAMPLE_TEX2D_SAMPLER_LOD(tex,state,uv_edge[2],0.0).x \
    )*control
