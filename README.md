...
* メッシュが自在に飛んだり、衛星軌道を描かせる**Orbit機能**
* 主要の機能に共通して活用できる汎用機能、**共通設定**
  * 様々な入力値を基に機能の制御ができる**参照先設定**
  * テクスチャを利用した**マスク、オフセット機能**
  * 入力値を改変できる**モディファイア**
* **AudioLink対応**
* etc...
...
## How to Use | 使い方
[ドキュメントサイト](https://meshhologram.pages.dev/ja/ "https://meshhologram.pages.dev/ja/")をご参照ください。
