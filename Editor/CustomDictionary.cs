    ...
    internal class CustomDictionary
    {
        internal Dictionary<SHADER_PROPERTY, ShaderPropertyState> GetShaderProperties()
        {
            return new Dictionary<SHADER_PROPERTY, ShaderPropertyState>
            {
                ...
                {SHADER_PROPERTY._NOISE1ST_VALUE_CURVE,new ShaderPropertyState("_Noise1stValueCurve")},
                {SHADER_PROPERTY._NOISE1ST_CURVE_TYPE,new ShaderPropertyState("_Noise1stCurveType")},
                {SHADER_PROPERTY._NOISE1ST_THRESHOLD_MUL,new ShaderPropertyState("_Noise1stThresholdMul")},
                {SHADER_PROPERTY._NOISE1ST_THRESHOLD_ADD,new ShaderPropertyState("_Noise1stThresholdAdd")},
                ...
                {SHADER_PROPERTY._NOISE2ND_VALUE_CURVE,new ShaderPropertyState("_Noise2ndValueCurve")},
                {SHADER_PROPERTY._NOISE2ND_CURVE_TYPE,new ShaderPropertyState("_Noise2ndCurveType")},
                {SHADER_PROPERTY._NOISE2ND_THRESHOLD_MUL,new ShaderPropertyState("_Noise2ndThresholdMul")},
                {SHADER_PROPERTY._NOISE2ND_THRESHOLD_ADD,new ShaderPropertyState("_Noise2ndThresholdAdd")},
                ...
                {SHADER_PROPERTY._NOISE3RD_VALUE_CURVE,new ShaderPropertyState("_Noise3rdValueCurve")},
                {SHADER_PROPERTY._NOISE3RD_CURVE_TYPE,new ShaderPropertyState("_Noise3rdCurveType")},
                {SHADER_PROPERTY._NOISE3RD_THRESHOLD_MUL,new ShaderPropertyState("_Noise3rdThresholdMul")},
                {SHADER_PROPERTY._NOISE3RD_THRESHOLD_ADD,new ShaderPropertyState("_Noise3rdThresholdAdd")},
